...
void main() {
  group('TripQueries', () {
    test('hasDates true/false según presencia de start/end', () {
      final t1 = _okTrip(Trip.create(
          id: 'a',
          title: 'x',
          createdAt: DateTime.now(),
          updatedAt: DateTime.now()));
      expect(t1.hasDates, isFalse);
      final t2 = _okTrip(Trip.create(
          id: 'b',
          title: 'y',
    ...
    test('phase: undated / planned / ongoing / finished', () {
      ...
      final undated = _okTrip(Trip.create(
          id: 'u', title: 'u', createdAt: createdAt, updatedAt: updatedAt));
    ...
    test('durationDays: null si falta fecha; ceil sobre horas', () {
      ...
      final tNull = _okTrip(Trip.create(
          id: 'n',
          title: 'n',
          startDate: DateTime.utc(2025, 1, 1),
          createdAt: createdAt,
